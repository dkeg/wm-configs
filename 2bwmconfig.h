...
///---Modifiers---///
#define WIN             XCB_MOD_MASK_1       /* Super/Windows key  or check xmodmap(1) with -pm  defined in /usr/include/xcb/xproto.h */
...
//static const uint16_t movements[] = {2,40,15,400};
static const uint16_t movements[] = {2,40,15,400};
...
//static const uint8_t offsets[] = {20,35,20,45};
//static const uint8_t offsets[] = {30,40,60,70};
static const uint8_t offsets[] = {40,55,85,85};
///---Colors---///
/*0)focuscol         1)unfocuscol
 *2)fixedcol         3)unkilcol
 *4)fixedunkilcol    5)outerbordercol
 *6)emptycol         */
static const char *colors[] = {"#1f1d21","#1f1d21","#93503e","#9d8554","#93503e","#1f1d21","#1f1d21"};
/*
 ...
 *3) Resize border size  */
 static const uint8_t borders[] = {1,3,1,1};
//static const uint8_t borders[] = {3,5,5,4};
/* Windows that won't have a border.*/
#define LOOK_INTO "WM_NAME"
static const char *ignore_names[] = {"bar", "xclock"};
///--Menus and Programs---///
static const char *menucmd[]    = { "/home/dkeg/bin/demon", NULL };             
static const char *nowPlaying[] = { "/home/dkeg/bin/nowPlaying",NULL};
static const char *current[]    = { "/home/dkeg/bin/popstat",NULL};
static const char *terminal[]   = { "urxvt", NULL };
static const char *browser[]    = { "iceweasel", NULL };
static const char *fullit[]     = { "/home/dkeg/bin/fullit", NULL };                        
static const char *twobwm_path  = "/usr/local/bin/2bwm";                        
/*static const char *dvolcmd[]    = { "/home/dkeg/bin/volumeNew", NULL };       
 * static const char *upvolcmd[]   = { "/home/dkeg/bin/volumeNew", NULL };         
 * static const char *mute[]       = { "/home/dkeg/bin/volumeNew", NULL };*/
static const char *dvolcmd[]    = { "amixer", "set", "Master", "5.0%-", NULL };
static const char *upvolcmd[]   = { "amixer", "set", "Master", "5.0%+", NULL }; 
...
static key keys[] = {
    ...
    {  WIN ,              XK_comma,      changescreen,      {.i=TWOBWM_NEXT_SCREEN}},
    {  WIN ,              XK_period,     changescreen,      {.i=TWOBWM_PREVIOUS_SCREEN}},
    ...
    {  MOD ,              XK_f,          fix,               {}},
    // Move the cursor
    {  WIN ,              XK_Up,         cursor_move,       {.i=TWOBWM_CURSOR_UP_SLOW}},
    {  WIN,              XK_Down,       cursor_move,       {.i=TWOBWM_CURSOR_DOWN_SLOW}},
    {  WIN,              XK_Right,      cursor_move,       {.i=TWOBWM_CURSOR_RIGHT_SLOW}},
    {  WIN,              XK_Left,       cursor_move,       {.i=TWOBWM_CURSOR_LEFT_SLOW}},
    ...
    {  WIN ,              XK_p,          start,             {.com = menucmd}},  
    {  WIN ,              XK_b,          start,             {.com = browser}},  
    {  MOD |SHIFT,        XK_f,          start,             {.com = fullit}},  
    {  MOD |SHIFT,        XK_minus,      start,             {.com = dvolcmd}},  
    {  MOD |SHIFT,        XK_equal,      start,             {.com = upvolcmd}}, 
    {  MOD |SHIFT,        XK_F8,         start,             {.com = mute}},     
    {  MOD ,              XK_p,          start,             {.com = current}},                                                                                                                                              
    {  MOD |SHIFT,        XK_p,          start,             {.com = nowPlaying}},
